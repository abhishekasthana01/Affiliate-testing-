...
This roadmap outlines the planned features and improvements for Beam. Items are subject to change based on community feedback and priorities.
...
### Vote on Features
- **[GitHub Discussions](https://github.com/beam/beam/discussions)** - Vote on feature requests
- **[Feature Request Form](https://github.com/beam/beam/issues/new?template=feature_request.md)** - Suggest new features

### Contribute
- **[Open Issues](https://github.com/beam/beam/issues)** - Pick up an issue
- **[Pull Requests](https://github.com/beam/beam/pulls)** - Submit improvements
...
- **[GitHub Releases](https://github.com/beam/beam/releases)** - Version updates
- **[Changelog](Changelog)** - Detailed changes
- **[Blog](https://blog.beam.com)** - Announcements (coming soon)
- **[Twitter](https://twitter.com/beam)** - Quick updates (coming soon)
- **[Newsletter](https://beam.com/newsletter)** - Monthly digest (coming soon)
...
<p align="center">
  ...
  Share your thoughts in <a href="https://github.com/beam/beam/discussions">GitHub Discussions</a>
</p>
