...
Thank you for your interest in contributing to Beam! This guide will help you get started.
...
Found a bug? [Create an issue](https://github.com/beam/beam/issues/new?template=bug_report.md)

### ✨ Suggest Features

Have an idea? [Start a discussion](https://github.com/beam/beam/discussions/new)
...
Help make Beam available in more languages.
...
3. **Add upstream remote:**
   ```bash
   git remote add upstream https://github.com/beam/beam.git
   ```
...
- Check the [FAQ](FAQ)
- Ask in [GitHub Discussions](https://github.com/beam/beam/discussions)

---

<p align="center">
  <strong>Thank you for contributing to Beam!</strong><br>
