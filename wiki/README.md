...
This directory contains the complete documentation for the Beam affiliate management platform, designed to be used as a GitHub Wiki.
...
2. **Clone Wiki repository:**
   ```bash
   git clone https://github.com/YOUR_USERNAME/beam.wiki.git
   ```

3. **Copy wiki files:**
   ```bash
   cp wiki/*.md beam.wiki/
   ```
...
- **[GitHub Issues](https://github.com/beam/beam/issues)** - Report wiki issues
