...
Find quick answers to common questions about Beam.
...
Beam is a comprehensive, open-source affiliate management platform built with Next.js, TypeScript, and PostgreSQL. It provides everything you need to create, manage, and scale your affiliate marketing program.
...
Yes! Beam is 100% free and open-source under the MIT License. You can use it commercially without any licensing fees. However, you'll need to pay for:
...
### How is Beam different from other affiliate platforms?
...
Following our [Quick Start Guide](Quick-Start-Guide), you can have Beam running in **5-10 minutes**.

### Do I need coding knowledge to use Beam?
...
### Can I install Beam on shared hosting?

Beam requires Node.js and PostgreSQL, which most shared hosting doesn't support. We recommend:
- **Vercel** (easiest, free tier available)
- **DigitalOcean** (affordable, $5/month)
- **AWS** (scalable, pay-as-you-go)
- **Docker** (self-hosted)

### What database does Beam use?

Beam uses **PostgreSQL** via Prisma ORM. Support for MySQL/MariaDB is planned for future releases.
...
Beam tracks referrals in two ways:
...
### Can I use Beam with my existing application?

Yes! Beam provides a REST API that you can integrate with any application. Use webhooks (coming v1.1.0) for real-time updates.

### Does Beam have an API?

Yes! Beam has a comprehensive REST API with 31 endpoints. See our [API Overview](API-Overview) for details.

### Is Beam mobile-friendly?

Yes, Beam is fully responsive and works on mobile devices. Native mobile apps are planned for v1.5.0.

### Can I use Beam offline?

No, Beam requires an internet connection. It's a web application that needs server communication.
...
3. Ensure database exists: `createdb beam`
...
### Is Beam really free forever?

Yes! Beam is MIT licensed, which means:
- ✅ Free to use
- ✅ Free to modify
...
- ✅ Use privately
- ✅ Sell products built with Beam

You must:
- ⚠️ Include the original license
- ⚠️ Credit the Beam Team
...
No! Beam doesn't charge any fees. However:
...
### Can I remove "Powered by Beam"?

Yes, the MIT License allows you to remove any branding. However, we'd appreciate attribution!

### Is there a paid version?

Currently no. Beam is 100% open source. We may offer paid support or custom development in the future.
...
Yes, Beam uses standard React components. You can replace them with your own components.
...
### Does Beam integrate with Shopify?
...
- **[GitHub Issues](https://github.com/beam/beam/issues)** - Bug reports
- **[GitHub Discussions](https://github.com/beam/beam/discussions)** - Questions and ideas
- **Email** - hello@beam.com

### How do I report a bug?

1. Check [existing issues](https://github.com/beam/beam/issues)
2. Create a [new issue](https://github.com/beam/beam/issues/new)
3. Include:
   - Beam version
   - Steps to reproduce
...
2. Search [existing requests](https://github.com/beam/beam/discussions)
3. Create a [new discussion](https://github.com/beam/beam/discussions/new)
4. Explain the feature and use case

### Can I hire someone to customize Beam?

Yes! You can:
- Hire freelance developers
- Contact us for custom development: hello@beam.com
...
Yes, Beam follows security best practices:
- JWT authentication
...
Beam provides the tools, but GDPR compliance depends on how you use it. You're responsible for:
- Privacy policy
- Cookie consent
...
### Does Beam track users?

Beam tracks affiliate activity (referrals, commissions) for program management. No third-party tracking by default.
...
### How many affiliates can Beam handle?
...
- **Ask in Discussions** - [GitHub Discussions](https://github.com/beam/beam/discussions)
- **Email us** - hello@beam.com

---

<p align="center">
  <strong>Didn't find your answer?</strong><br>
  Ask in <a href="https://github.com/beam/beam/discussions">GitHub Discussions</a>
</p>
