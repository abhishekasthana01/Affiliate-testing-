...
Complete reference for the Beam REST API.
...
The Beam API is a RESTful API that allows you to programmatically interact with your affiliate program. All API endpoints return JSON responses.
...
Beam uses **JWT (JSON Web Tokens)** for authentication.

### Authentication Flow (OTP-Based)

Beam uses a passwordless OTP (One-Time Password) authentication flow:
...
Have you built an SDK? [Let us know!](https://github.com/beam/beam/discussions)
