...
export const metadata = {
  title: 'Beam - Affiliate Marketing Platform',
  description: 'Next-generation affiliate marketing platform with comprehensive tracking, commission management, and payout automation. Powered by Beam.',
  icons: {
    icon: [
      { url: '/images/beam_token.png', type: 'image/png' },
      { url: '/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
      { url: '/favicon-16x16.png', sizes: '16x16', type: 'image/png' },
    ],
    apple: '/images/beam_token.png',
    shortcut: '/images/beam_token.png',
  },
};
