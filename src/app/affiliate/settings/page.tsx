    ...
    try {
      ...
      if (data.success) {
        ...
        setSettingsForm({
          ...
          beamNumber: data.user?.beamNumber || '',
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label className="flex items-center gap-1.5">
                <Zap className="h-3.5 w-3.5" /> Beam Number
              </Label>
              <Input
                value={settingsForm.beamNumber}
                onChange={(e) => setSettingsForm({ ...settingsForm, beamNumber: e.target.value })}
                placeholder="BEAM-12345"
              />
            </div>
            <div className="space-y-2">
              <Label className="flex items-center gap-1.5">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label>
                {settingsForm.paymentMethod === 'Stripe' ? 'Stripe Email' : 
                 settingsForm.paymentMethod === 'PayPal' ? 'PayPal Email' : 
                 settingsForm.paymentMethod === 'Beam Wallet' ? 'Beam ID / Phone' : 
              ...
              <Input
                ...
                placeholder={
                  settingsForm.paymentMethod === 'Stripe' ? 'stripe@example.com' : 
                  settingsForm.paymentMethod === 'Beam Wallet' ? 'BEAM-12345 or +1...' :
                  'payment@example.com'
                }
              />
            </div>
