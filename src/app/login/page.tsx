            ...
            <>
              ...
              <form onSubmit={handleSendOTP}>
                ...
                <CardFooter className="flex-col gap-4">
                  <Button type="submit" className="w-full bg-beam-pink-500 hover:bg-beam-pink-600 text-white" size="lg" disabled={loading || !email}>
                    {loading ? (
                ...
                <CardFooter className="flex-col gap-3">
                  ...
                  <div className="flex items-center justify-between w-full">
                    ...
                    <Button
                      ...
                      className="text-xs text-beam-pink-600 hover:text-beam-pink-700"
                      disabled={loading}
                    >
                      Resend code
                    </Button>
