...
const mainNavItems = [
  ...
  { title: 'Email Builder', url: '/admin/emails/builder', icon: Paintbrush, badge: 'NEW' },
];
              ...
              {marketingNavItems.map((item) => (
                <SidebarMenuItem key={item.title}>
                  ...
                  >
                    ...
                    <span>{item.title}</span>
                    {item.badge && (
                      <span className="ml-auto rounded-full bg-beam-pink-100 px-2 py-0.5 text-[10px] font-semibold text-beam-pink-600">
                        {item.badge}
                      </span>
                    )}
                  </SidebarMenuButton>
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  <Avatar className="h-8 w-8 rounded-lg">
                    ...
                    <AvatarFallback className="rounded-lg bg-beam-pink-500 text-white text-xs">
