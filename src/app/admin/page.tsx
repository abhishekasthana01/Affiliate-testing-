  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (analyticsData.success) {
        if (analyticsData.analytics.topAffiliates) {
          setTopAffiliates(analyticsData.analytics.topAffiliates.slice(0, 5));
        }
        setRevenueData(analyticsData.analytics.dailyRevenue || []);
        setCategoryData(analyticsData.analytics.levelsBreakdown || []);
      }
    ...
    <TooltipProvider>
      <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg font-bold">Partner Tiers</CardTitle>
