            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-1 font-semibold">
                  ...
                  {referral.estimatedValue.toLocaleString('en-IE')}
                </span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-1 text-lg font-bold text-primary">
                  ...
                  {estimatedCommission.toLocaleString('en-IE')}
                </span>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {new Date(referral.createdAt).toLocaleDateString('en-IE', {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric',
                      })}
                      {' at '}
                      {new Date(referral.createdAt).toLocaleTimeString('en-IE', {
                        hour: '2-digit',
                        minute: '2-digit',
                      })}
                    </p>
