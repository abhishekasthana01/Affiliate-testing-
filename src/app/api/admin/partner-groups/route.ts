  ...
  try {
    ...
    return NextResponse.json({
      ...
      partnerGroups: partnerGroups.map(pg => ({
        ...
        commissionRate: normalizeCommissionRate(pg.commissionRate),
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const normalizedCommissionRate = commissionRate ? normalizeCommissionRate(commissionRate) : undefined;
    ...
    const partnerGroup = await prisma.partnerGroup.update({
      ...
      data: {
        ...
        ...(normalizedCommissionRate && { commissionRate: normalizedCommissionRate }),
