...
**Live URL**: https://beam.vercel.app/  
...
**Test**:
1. Register affiliate at https://beam.vercel.app/register
...
- Referral link format: `https://beam.vercel.app/r/NAME-XXXX`
...
3. `public/scripts/beam-tracker.js` - JavaScript tracking SDK
...
<script 
  src="https://beam.vercel.app/scripts/beam-tracker.js"
...
11. ✅ `public/scripts/beam-tracker.js`
...
### Vercel Status
⏳ **Deploying**: https://beam.vercel.app/  
⏳ **ETA**: 1-2 minutes  
🔄 **Monitor**: https://vercel.com/beam/beam/deployments
...
**1. Generate API Keys**:
```bash
curl -X POST https://beam.vercel.app/api/admin/integration/generate-key \
...
```bash
curl https://beam.vercel.app/api/admin/integration \
  -H "Cookie: auth-token=YOUR_TOKEN"
```

**3. Update Settings**:
```bash
curl -X PUT https://beam.vercel.app/api/admin/integration \
...
4. Test with `console.log(window.Beam)`

### Issue: Conversion not tracked
**Solution**:
1. Check if referral cookie exists: `Beam.getReferralCode()`
