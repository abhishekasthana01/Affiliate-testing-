# Deploying Beam to Vercel

**Author: Beam Team**

Complete guide for deploying Beam to Vercel with PostgreSQL database.
...
git init
git add .
git commit -m "Initial commit - Beam by Beam Team"
git branch -M main
...
EMAIL_FROM=Beam <noreply@beam.com>
...
2. Add your domain: `beam.com`
3. Add subdomain: `app.beam.com`
