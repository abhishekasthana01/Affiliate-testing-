# Email Configuration Guide for Beam

## Overview

Beam uses [Resend](https://resend.com) for sending transactional emails. Resend is a modern email API designed for developers with:
...
2. Give it a name (e.g., "Beam Production")
...
2. Click **"Add Domain"**
3. Enter your domain (e.g., `beam.com`)
...
Beam includes the following email templates:
...
### Beam Support
For issues specific to Beam's email implementation:
