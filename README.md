...
[![Buy Me a Coffee](https://img.shields.io/badge/☕-Buy%20me%20a%20coffee-ffdd00?style=flat&logo=buy-me-a-coffee)](https://buymeacoffee.com/beam)
# Beam - Open Source Affiliate Management Platform
[![Open Collective](https://img.shields.io/badge/OpenCollective-Support%20Us-3385FF?style=for-the-badge&logo=open-collective&logoColor=white)](https://opencollective.com/beam)
<p align="center">
  <img src="./public/images/github-banner.svg" alt="Beam Logo" width="200"/>
</p>
...
**Beam** is a comprehensive affiliate management platform designed to help businesses create, manage, and scale their affiliate programs. Built with modern web technologies, it provides a complete solution for tracking referrals, managing commissions, and engaging with affiliate partners.
...
```env
# Database
DATABASE_URL="postgresql://user:password@localhost:5432/beam"
...
RESEND_FROM_EMAIL="Beam <onboarding@resend.dev>"
...
Beam uses [Resend](https://resend.com) for sending transactional emails. Follow these steps:
...
Open [https://app.beam.com](https://app.beam.com) or your configured domain in your browser.
# or
yarn dev
# or
pnpm dev
...
The easiest way to deploy Beam is using [Vercel](https://vercel.com):

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/yourusername/beam)
...
**Developed by: Beam Team**

- GitHub: [@beam](https://github.com/beam)
- Website: [https://beam.com](https://beam.com)
...
- **Email**: [support@beamaffiliate.com](mailto:support@beamaffiliate.com)
...
[![Star History Chart](https://api.star-history.com/svg?repos=beam/beam&type=date&legend=top-left)](https://www.star-history.com/#beam/beam&type=date&legend=top-left)
...
<p align="center">
  Made with ❤️ by the <strong>Beam Team</strong>
</p>

<p align="center">
  <sub>© 2025 Beam. All rights reserved.</sub>
</p>
<p align="center">
 **⭐ Found this useful? Give us a star to support the project!**

  [![Buy Me A Coffee](https://img.buymeacoffee.com/button-api/?text=Buy%20me%20a%20coffee&slug=daniavila&button_colour=FFDD00&font_colour=000000&font_family=Cookie&outline_colour=000000&coffee_colour=ffffff)](https://buymeacoffee.com/beam)
